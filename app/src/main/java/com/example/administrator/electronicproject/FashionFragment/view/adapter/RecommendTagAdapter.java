 ...
 */
public class RecommendTagAdapter extends BaseAdapter implements OnInitSelectedPosition {

    private final Context mContext;
    private final List<RecommendDeatilsBean.ResponseBean.DataBean.TagsBean> listBeen;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textView.setText("#"+listBeen.get(position).getCategory());
        return view;
    }

    public void onlyAddAll(List<RecommendDeatilsBean.ResponseBean.DataBean.TagsBean> datas) {
        listBeen.addAll(datas);
        notifyDataSetChanged();
    }

    public void clearAndAddAll(List<RecommendDeatilsBean.ResponseBean.DataBean.TagsBean> datas) {
        listBeen.clear();
        onlyAddAll(datas);
    }
