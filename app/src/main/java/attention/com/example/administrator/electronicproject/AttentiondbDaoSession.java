 ...
 */
public class AttentiondbDaoSession extends AbstractDaoSession {

    private final DaoConfig attentionDaoConfig;

    private final AttentionDao attentionDao;

    public AttentiondbDaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
            daoConfigMap) {
        super(db);
